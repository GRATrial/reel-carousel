...
(function() {
    ...
    function initialize(studyType = null) {
        ...
        // MongoDB-only tracking - no GA4 dependency
        // Get participant ID and initialize
        window.MongoTracker.participantId = getParticipantId();
        
        // Continue with initialization
        continueInitialization(studyType);
    }
    
    /**
     * Continue initialization after participant ID is collected
     */
    function continueInitialization(studyType = null) {
